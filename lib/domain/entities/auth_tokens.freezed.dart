...
class _$AuthTokensImpl extends _AuthTokens {
  ...
  @override
  String toString() {
    return 'AuthTokens(accessToken: $accessToken, refreshToken: $refreshToken, accessTokenExpiry: $accessTokenExpiry, refreshTokenExpiry: $refreshTokenExpiry)';
  }
...
abstract class _AuthTokens extends AuthTokens {
  const factory _AuthTokens(
      ...
      required final DateTime refreshTokenExpiry}) = _$AuthTokensImpl;
